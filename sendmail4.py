...
<body>
    ...
    msgfooter="""
	 <div style="text-align:center">
      <i class="ui icon heart red large></i>"	  
	  ...
	  <a href="   " style="color:rgb(51,102,153);font-family:Arial,Verdana,sans-serif;font-size:small;text-align:center;background-color:rgb(255,255,255)">Please share your feedback and recommendations!</a>
	 </div>
   </div>
   </body>
    """
...
"""
    msgHtml=msgheader+msgbody+msgfooter
    msgPlain = "Hi\nPlain Email"
